...
export function CreateMeetupModal({ onClose, onCreated }: { onClose: () => void; onCreated: (id: string) => void }) {
  ...
  return (
    <Shell onClose={onClose} title={titles[step]} width={640}>
...
export function Shell({ children, onClose, title, width = 580 }: { children: React.ReactNode; onClose: () => void; title: string; width?: number }) {
  return (
